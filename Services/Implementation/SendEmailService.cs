...
namespace net_core_baby_reminder.Services.Implementation
{
    public class SendEmailService : ISendEmailService
    {
        ...
        public async Task SendEmailEnglish()
        {
            try
            {
                _logger.LogInformation($"SendEmailService - Started");
                ...
                var body = @"<html>
                                <body>
                                    <h1>There are " + days + " days until we get to meet the baby</h1>" +
                                    "<img src=cid:myImageID alt='BEBECITO' width=\"500\" height=\"600\"/>" +
                                "</body>" +
                            "</html>";
                AlternateView htmlView = AlternateView.CreateAlternateViewFromString(body, null, "text/html");
                ...
                email.From = new MailAddress("rodrigo3.tech@gmail.com");
                email.AlternateViews.Add(htmlView);
                email.To.Add("rorro.irg@gmail.com,C.coetser@icloud.com,santie1@icloud.com");
                email.Subject = "The baby is coming";
                email.IsBodyHtml = true;
                email.Body = body;
